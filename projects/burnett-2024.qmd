---
title: "Rapid responses to visual threats in mouse models of autism"
...
From these experiments, I found that although the *Setd5+/-* mice were slower at initiating an escape response, I couldn't identify any major differences in their visual responses within the SC. With this is mind, I went back to what was known about this circuit. As *Evans et al. 2018* described, this neural circuit functioned like a **drift diffusion model**. Cells within the underlying brain region to the SC, called the **periaqueductal grey** (PAG), must integrate the input they receive from SC cells, as well as others, and only when their membrane has become sufficiently depolarised will they start firing themselves and signal to downstream motor regions to trigger an escape response. 
