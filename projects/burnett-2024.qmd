...
![Sequential frames of a mouse responding to an overhead looming stimulus. From *Burnett et al. 2024*.](/assets/projects/burnett-2024/card.jpg){fig-alt="Camera frames of a mouse escaping from a visual loom stimulus."}
...
![Figure 5. Mean firing rate (Hz) and SEM of *Setd5^+/+^* (black without a-DTX, blue with a-DTX) and *Setd5^+/-^* (red without a-DTX, magenta with a-DTX) PAG cells to increasing amounts of injected current. Shaded areas show the SEM. From *Burnett et al. 2024*.](/assets/projects/burnett-2024/dtx.jpg){width=80%}
